...
def run_train_w_agent():
    ...
    outputs = train_ppo_agent(env_para, train_args, test_args, run, checkpoint_saver, artifact)
    try:
        add_final_notes(run)
    except Exception:
        pass
...
def run_sweep():
    ...
    train_ppo_agent(env_para, sweep_train_args, test_args, run, checkpoint_saver)
