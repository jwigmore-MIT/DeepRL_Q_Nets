""" Clean RL Implementation of Average Reward PPO
Difference from Clean_RL_PPO.py:
    1. Keeps track of eta  =~ E_\pi[r]
    2. Keeps track of bias of state value function
...
if __name__ == "__main__":
    config_file = "clean_rl/N4S3_ARPPO1.yaml"
